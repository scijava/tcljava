...
{
    public static
    boolean isProcCallFrame(CallFrame frame) {
        return frame.isProcCallFrame;
    }

    public static
    void setProcCallFrameFalse(CallFrame frame) {
        frame.isProcCallFrame = false;
    }

    public static
    TclObject[] getCallFrameObjv(CallFrame frame) {
        return frame.objv;
    }
    ...
    public static
    void setCallFrameObjv(CallFrame frame, TclObject[] objv) {
        frame.objv = objv;
    }

    public static
    CallFrame
    getCallFrame(Interp interp, int level) {
        CallFrame frame;
    ...
    public static
    CallFrame
    activateCallFrame(Interp interp, CallFrame frame) {
        CallFrame oldFrame;
    ...
    public static
    TclObject[][] getArgList(Procedure proc) {
        return proc.argList;
    }

    public static
    void setWrappedCommand(Procedure proc, WrappedCommand wcmd) {
        proc.wcmd = wcmd;
    }
