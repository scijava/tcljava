...
class FileUtil {
	...
	static int getPathType(String path) // Path for which we find pathtype.
	{
		char c;
		if (path.length() < 1) {
	...
	static File getNewFileObj(Interp interp, // Current interpreter.
	...
	static String joinPath(Interp interp, // Current interpreter for path join.
	...
	static TclObject splitPath(Interp interp, // Current interpreter for path
												// split.
	...
	static String doTildeSubst(Interp interp, // Current interpreter.
	...
	static String translateFileName(Interp interp, // Current interpreter for
													// path split.
			String path) // Path to be split.
	...
	static TclObject splitAndTranslate(Interp interp, // Current interpreter for
														// path split.
			String path) // Path to be split.
